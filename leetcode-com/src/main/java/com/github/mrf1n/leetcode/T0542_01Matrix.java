package com.github.mrf1n.leetcode;

import java.util.Arrays;
import java.util.LinkedList;
import java.util.Queue;

public class T0542_01Matrix {
    public static void main(String[] args) {
        int[][] mat0 = new int[][]{{0, 0, 0}, {0, 1, 0}, {0, 0, 0}};
        System.out.println(Arrays.deepToString(new T0542_01Matrix().updateMatrix(mat0)));
        int[][] mat1 = new int[][]{{0, 0, 0}, {0, 1, 0}, {1, 1, 1}};
        System.out.println(Arrays.deepToString(new T0542_01Matrix().updateMatrix(mat1)));
    }
