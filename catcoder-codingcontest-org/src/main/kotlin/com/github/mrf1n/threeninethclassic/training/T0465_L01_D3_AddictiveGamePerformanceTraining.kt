...
internal class InputReader(
    ...
    constructor() : this(BufferedReader(InputStreamReader(System.`in`)))

    constructor(s: String) : this(BufferedReader(FileReader(s)))
    ...
    fun nextLine(): String = reader.readLine()

    fun hasNextToken(): Boolean = tokenizer != null && tokenizer!!.hasMoreElements()
}
...
fun main(args: Array<String>) {
    ...
    val reader = InputReader(str.byteInputStream())
